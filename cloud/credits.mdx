...
|--------|---------|-------|
| Signup grant | 1,000 | One-time, free, no card required |
| Starter plan ($19/mo) | 2,000/month | Resets each billing period; unused monthly credits expire |
| Credit pack ($9) | 1,000 | Never expire |
| Credit pack ($39) | 5,000 | Never expire |

Monthly credits are spent before purchased pack credits. Buy plans and packs from the **Billing & Credits** page in the [dashboard](/dashboard).
