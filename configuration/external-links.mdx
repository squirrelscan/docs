...
**Cause:** Some sites block HEAD requests or require browser user agents

**Solution:** External link checker automatically falls back to GET requests

Verify crawler user agent:
```toml
[crawler]
