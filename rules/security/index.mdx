---
title: "Security"
description: "HTTPS, headers, leaked secrets, and safe link practices"
---

HTTPS, headers, leaked secrets, and safe link practices
...
<CardGroup cols={2}>
  ...
  <Card title="Leaked Secrets" icon="circle-exclamation" href="/rules/security/leaked-secrets">
