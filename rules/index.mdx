...
description: "All 148 audit rules organized by category"
---

squirrelscan includes **148 rules** across **20 categories**. Each rule checks for specific SEO, accessibility, performance, or security issues.
...
<CardGroup cols={2}>
  ...
  <Card title="Links" icon="folder" href="/rules/links">
    Internal and external link health and structure (12 rules)
  </Card>
  <Card title="Images" icon="folder" href="/rules/images">
    Image optimization and accessibility (11 rules)
  </Card>
  ...
  <Card title="Security" icon="folder" href="/rules/security">
    HTTPS, headers, and safe link practices (11 rules)
  </Card>
  ...
  <Card title="Performance" icon="folder" href="/rules/perf">
    Page speed and loading performance (10 rules)
  </Card>
  ...
  <Card title="Crawlability" icon="folder" href="/rules/crawl">
    Robots.txt, sitemaps, and crawl directives (14 rules)
  </Card>
