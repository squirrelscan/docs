...
description: "All 138 audit rules organized by category"
---

squirrelscan includes **138 rules** across **20 categories**. Each rule checks for specific SEO, accessibility, performance, or security issues.

## Categories

<CardGroup cols={2}>
  <Card title="Core SEO" icon="folder" href="/rules/core">
    Essential meta tags and page structure for search engines (11 rules)
  </Card>
  <Card title="Content" icon="folder" href="/rules/content">
    Text quality, readability, and content structure (11 rules)
  </Card>
  <Card title="Links" icon="folder" href="/rules/links">
    Internal and external link health and structure (11 rules)
  </Card>
  <Card title="Images" icon="folder" href="/rules/images">
    Image optimization and accessibility (10 rules)
  </Card>
  ...
  <Card title="Crawlability" icon="folder" href="/rules/crawl">
    Robots.txt, sitemaps, and crawl directives (7 rules)
  </Card>
  ...
  <Card title="Adblock Detection" icon="folder" href="/rules/adblock">
    Detection of content blocked by ad blockers (2 rules)
  </Card>
</CardGroup>
