...
description: "All 153 audit rules organized by category"
---

squirrelscan includes **153 rules** across **20 categories**. Each rule checks for specific SEO, accessibility, performance, or security issues.
...
<CardGroup cols={2}>
  ...
  <Card title="Performance" icon="folder" href="/rules/perf">
    Page speed and loading performance (11 rules)
  </Card>
