...
description: "All 215 audit rules organized by category"
---

squirrelscan includes **215 rules** across **20 categories**. Each rule checks for specific SEO, accessibility, performance, or security issues.
