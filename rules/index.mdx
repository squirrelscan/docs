...
description: "All 149 audit rules organized by category"
---

squirrelscan includes **149 rules** across **20 categories**. Each rule checks for specific SEO, accessibility, performance, or security issues.
...
<CardGroup cols={2}>
  ...
  <Card title="Security" icon="folder" href="/rules/security">
    HTTPS, headers, leaked secrets, and safe link practices (12 rules)
  </Card>
