...
Links with the same visible text should go to the same URL:

- When identical link text leads to different destinations, it confuses screen reader users who navigate by listing links
- Make link text unique or more descriptive to differentiate destinations
