...
Avoid deprecated or abstract ARIA roles:

- Use the recommended alternatives
- Abstract roles are never meant to be used directly - they're base types that other roles extend
- Replace with specific, concrete roles
