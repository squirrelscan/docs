...
Some ARIA roles must be contained within specific parent roles. For example:

- `role="listitem"` must be within `role="list"`
- `role="option"` must be within `role="listbox"`

Restructure your markup to ensure proper parent-child relationships.
