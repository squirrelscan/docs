...
Meter elements must have accessible names to describe what they're measuring. Add one of the following:
...
**Example:**
```html
<meter aria-label="Battery level" value="0.8">80%</meter>
```
