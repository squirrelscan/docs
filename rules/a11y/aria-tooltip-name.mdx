...
Tooltip elements with `role="tooltip"` must have accessible content. The tooltip content serves as its accessible name.

- Ensure tooltips have text content
- Use `aria-label` for icon-based tooltips
