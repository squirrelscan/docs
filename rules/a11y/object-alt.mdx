...
Object elements need alternative content for when the embedded content can't be displayed or for assistive technology.

Options include:
- Add content between `<object>` tags as fallback
